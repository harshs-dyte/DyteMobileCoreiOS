...
extension StageStatus {
    ...
    public static func getStageStatus(status: StageStatus? = nil, mobileClient: RealtimeKitClient) -> WebinarStageStatus {
        ...
        case .offStage:
            ...
            let videoPermission = mobileClient.localUser.permissions.media.video.permission
...
public class  RtkStageActionButtonControlBar: RtkControlBarButton {
    ...
    public init(mobileClient: RealtimeKitClient, buttonState: WebinarStageStatus, presentingViewController: UIViewController) {
        self.mobileClient = mobileClient
        self.presentingViewController = presentingViewController
        self.selfListner = RtkEventSelfListner(mobileClient: mobileClient)
    ...
    func showAlert(baseController: UIViewController) {
        if self.alert == nil {
            let alert = self.dataSource?.getAlertView() ?? RtkWebinarAlertView(meeting: self.mobileClient, participant: self.mobileClient.localUser)
