...
open class RtkButton: UIButton, BaseAtom {
    ...
    public init(style: Style = .solid, dyteButtonState: States = .active, size: Size = .large, appearance: RtkButtonAppearance = RtkButtonAppearanceModel()) {
        self.style = style
    ...
    private func getLabelOnlyView() -> (stackView: BaseStackView, title: RtkLabel) {
        let stackView = RtkUIUTility.createStackView(axis: .horizontal, spacing: dyteSharedTokenSpace.space1)
